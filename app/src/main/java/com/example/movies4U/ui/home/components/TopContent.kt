    ...
    Column(modifier = modifier.padding(defaultPadding)) {
        MovieCard {
            Row(
                ...
                verticalAlignment = Alignment.CenterVertically   // time 52.41
        ...
        MovieCard {
            Row(
                ...
                genres.forEachIndexed { index, genreText ->
                    if (index != 0) {
                    ...
                    if(index!=genres.lastIndex){                              // adding divider
                        VerticalDivider(modifier = Modifier.height(16.dp))
                    }
                }
            }
...
@Composable
private fun PrevMovieDetails(){
    MovieDetail(
        rating = 8.5, title = "HR Movie",
