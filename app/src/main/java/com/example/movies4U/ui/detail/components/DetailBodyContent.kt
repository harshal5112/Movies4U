package com.example.movies4U.ui.detail.components
...
import com.example.movies4U.ui.home.components.MovieCard
import com.example.movies4U.ui.home.components.MovieCoverImage
import com.example.movies4U.ui.home.defaultPadding
...
private fun ActionIconBtn(
    ...
    MovieCard(
        shape = CircleShape, // Fix: changed `shapes` to `shape`
        modifier = modifier
            .padding(4.dp),
        bgColor = bgColor
    ) {
